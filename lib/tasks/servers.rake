namespace :servers do
  task us: :environment do
    ...
    browser = Watir::Browser.new(:chrome, {:chromeOptions => {:args => ['--no-sandbox', '--disable-gpu', '--headless', '--window-size=1200x600', "--disable-dev-shm-usage", '--remote-debugging-port=9222']}})
    i = 0
    browser.goto(url)
    puts url
